...
var dividedArr = [];
dividedArr.push(evensArr);
dividedArr.push(oddsArr);
return dividedArr;
  }
...
//Write a function called reverse that takes a given str as it's only argument and returns that string 
...
*/
  ...
  function removeItem(myGroceryList, item) {
    if (typeof item === "string" && myGroceryList.includes(item)) {
...
//array after adding ten to each item in numbers. *Verify your answer is correct. --> [15, 19, 26, 29, 35, 44, 58]
  ...
  function addTen(numbers) {
    ...
    for (var i = 0; i < numbers.length; i++) {
      var newNum = parseInt(numbers[i]) + 10;
      newArr.push(newNum);
    }
    return newArr;
  }
...
var user2 = {
    name: 'Jess Poemape',
    email: 'jesspoemape@gmail.com',
    password: 'iLoveJJ',
    username: 'jesspoem'
};
var user3 = {
    name: 'Juan Jorge Poemape',
    email: 'juanjjpoem@gmail.com',
    password: 'iLoveJess',
    username: 'juanjjpoem'
};
var user4 = {
    name: 'Hektor Tulio',
    email: 'hektorvektor33@gmail.com',
    password: 'iLoveGreece',
    username: 'hektorvektor'
};
